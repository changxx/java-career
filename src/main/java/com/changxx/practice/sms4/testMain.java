...
public class testMain {
    ...
    public static void main(String[] args) {
        ...
        byte[] in1 = { 0x01, 0x23, 0x45, 0x67, (byte) 0x89, (byte) 0xab, (byte) 0xcd, (byte) 0xef, (byte) 0xfe, (byte) 0xdc, (byte) 0xba, (byte) 0x98, 0x76, 0x54, 0x32, 0x10,
        ...
        System.out.println("����1������ִ��ʱ�䣺 " + (System.nanoTime() - starttime) + "ns");
        ...
        sm4.sms4(in, inLen, key, out, ENCRYPT);
        System.out.println("\r1000000�μ���ִ��ʱ�䣺 " + (System.currentTimeMillis() - starttime) + "ms");
        System.out.println("���ܽ��");
        for (int i = 0; i < 16; i++)
            System.out.print(Integer.toHexString(out[i] & 0xff) + "\t");
